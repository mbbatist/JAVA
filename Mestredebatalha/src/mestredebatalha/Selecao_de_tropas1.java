 ...
 */
public class Selecao_de_tropas1 extends javax.swing.JFrame {

    /**
     * Creates new form seleção_de_tropas
     */
    public Selecao_de_tropas1() {
        initComponents();
        setSize(900,800);
    }
    ...
    private void initComponents() {
        ...
        brasaop1_img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mestredebatalha/jogador 1.png"))); // NOI18N
        getContentPane().add(brasaop1_img);
        brasaop1_img.setBounds(0, 110, 270, 240);

        player1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mestredebatalha/p1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selecao_de_tropas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
